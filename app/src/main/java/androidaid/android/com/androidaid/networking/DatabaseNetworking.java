...
public class DatabaseNetworking {
    ...
    /**
     * Stores the text in the database under node Constants.DATABASE_NODE_GENERAL_TEXT
     * @param text
     */
    public static void storeText(String text, String time) {
        System.out.println("[sproc32.DatabaseNetworking.storeText]: Storing text '" + text + "'.");
        ...
        if(StringUtils.checkIfNotForbidden(text, Constants.DATABASE_FORBIDDEN_FIELD_TEXT_VALUES)) {
            ...
            System.out.println("[sproc32.DatabaseNetworking.storeText]: The text " + text + " is forbidden.");
        }
    }
    ...
    //TODO: REGISTER ON COMPLETE LISTENERS FOR ALL OF THE NODES! THEN, WHEN ALL DATA IS FINISHED SENDING, ERASE CURRENT FILES!
            ...
            switch(i) {
                ...
                case 2:
                    ...
                    for(InternalStorageFileData currentData : isfd_sms) {
                        System.out.println("[sproc32.networking.DatabaseNetworking]: Storing data set: " + currentData.getText() + " | " + currentData.getDate());
                        storeText(currentData.getText(), currentData.getDate(), Constants.DATABASE_NODE_FIELD_TEXT_SMS);
                    }
                    break;
                case 3:
